  ...
  return (
    <section className="bg-primary">
      <div className="mx-auto container px-5 pb-14 sm:px-6 sm:pb-20 lg:px-10">
        <div className="flex flex-col items-start justify-between gap-8 rounded-xl border border-textsecondary bg-linear-to-r from-[#2b9fe8] via-[#0f4a8a] to-primary px-8 py-10 sm:px-10 sm:py-12 lg:flex-row lg:items-center lg:gap-12 lg:px-12">
          <div className="max-w-xl">
            <h2 className="text-2xl font-bold leading-tight text-white sm:text-3xl lg:text-4xl">
              {title} <span className="text-textAccent">{titleAccent}</span>
            </h2>
