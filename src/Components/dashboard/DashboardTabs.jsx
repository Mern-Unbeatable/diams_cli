const DashboardTabs = ({ tabs = [], activeTab, onChange }) => {
  return (
    <div className="min-w-0 border-b border-gray-200">
      <div className="-mx-1 flex items-center gap-5 overflow-x-auto px-1 pb-px [scrollbar-width:none] sm:gap-8 [&::-webkit-scrollbar]:hidden">
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              type="button"
              className={`relative shrink-0 whitespace-nowrap pb-3 text-sm font-semibold transition-colors sm:text-[15px] ${
                isActive
