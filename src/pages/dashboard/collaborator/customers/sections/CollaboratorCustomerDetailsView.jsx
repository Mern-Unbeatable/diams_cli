          ...
          <nav className="-mb-px flex space-x-6 sm:space-x-8 overflow-x-auto">
            {tabs.map((tab) => (
              <button
                ...
                className={`whitespace-nowrap pb-3 text-xs sm:text-sm font-semibold transition-colors cursor-pointer ${
                  activeTab === tab
                    ? "border-b-2 border-sky-500 text-sky-600 font-bold"
                    : "border-b-2 border-transparent text-slate-500 hover:text-slate-800 hover:border-slate-200"
                }`}
              >
                {tab}
              </button>
        ...
        <div className="mt-8">
          ...
          {activeTab === "Personal Information" && (
            <div className="max-w-2xl space-y-4 text-xs sm:text-sm">
              ...
              <div className="space-y-3 rounded-2xl border border-slate-100 bg-[#f8fafc]/60 p-5">
