...
import { ACTIVATION_STATUS_OPTIONS } from "./collaboratorActivationData";

const CollaboratorActivationHeader = ({ status, setStatus }) => {
  return (
...
export default CollaboratorActivationHeader;
