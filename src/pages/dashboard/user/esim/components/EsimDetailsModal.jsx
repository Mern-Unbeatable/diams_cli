...
export const EsimDetailsModal = ({ isOpen, onClose, esimData }) => {
  ...
  const techRows = [
    { label: "Phone Number", value: esimData.number || "+41 76 123 45 67", copyKey: "num" },
    { label: "Plan Name", value: esimData.planName || "NovaSky Plus" },
    { label: "Network Carrier", value: esimData.carrier || "NovaSky Switzerland (Sunrise 5G Network)" },
    { label: "Profile Status", value: "Active & Provisioned" },
    { label: "ICCID", value: esimData.iccid || "8944 1000 1234 5678 9012 3", copyKey: "iccid" },
    { label: "EID (Embedded Identity)", value: esimData.eid || "89049032000008882000123456789012", copyKey: "eid" },
    { label: "IMEI", value: esimData.imei || "35 123456 789012 3", copyKey: "imei" },
    { label: "APN (Access Point Name)", value: esimData.apn || "internet.novasky.ch", copyKey: "apn" },
    { label: "SM-DP+ Server", value: esimData.smdpAddress || "smdp.novasky.ch", copyKey: "smdp" },
    { label: "Roaming Configuration", value: esimData.roamingStatus || "Active (EU & US Included)" },
