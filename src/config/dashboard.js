...
export const DASHBOARD_NAV = {
  ...
  [ROLES.COLLABORATOR]: [
    ...
    { id: "activations", label: "Activations", path: collaboratorPath("activations"), icon: "power" },
    { id: "commissions", label: "Commissions", path: collaboratorPath("commissions"), icon: "wallet" },
    { id: "invoices", label: "Invoices & Documents", path: collaboratorPath("invoices"), icon: "fileText" },
    { id: "notifications", label: "Notifications", path: collaboratorPath("notifications"), icon: "bell" },
    { id: "profile", label: "Profile & Settings", path: collaboratorPath("profile"), icon: "settings" },
  ],
  [ROLES.USER]: [
